...
INSERT INTO `t_book` (`ID`, `ISBN`, `UUID`, `BOOKNAME`, `AUTHOR`, `TRANSLATOR`, `PRESS`, `VERSION`, `OUTLINE`, `WANTREAD`, `READING`, `HASREAD`, `DIRECTORY`, `PRICE`, `COVER_PIC`, `CLASSFY`, `RELATIONSHIP`, `t_bookcol`) VALUES
	(1, '42141B', NULL, 'cavdvas2222@@@@@@@@我是擦拭', '31k擦擦撒j', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL, '{"DD":"1","DB":"","AM":""}', NULL),
	(2, '32141B', NULL, 'vvvvvvvvaaaaaaaaaaa#$@$@', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL, '{"DD":"","DB":"","AM":"1"}', NULL);
...
CREATE TABLE IF NOT EXISTS `t_bookamazon` (
  ...
  `CLASSFY` varchar(45) DEFAULT NULL COMMENT '分类',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='在亚马逊网站上面的书籍详细信息';

# Dumping data for table bimokudb.t_bookamazon: ~1 rows (approximately)
...
INSERT INTO `t_bookamazon` (`ID`, `ISBN`, `UUID`, `BOOKNAME`, `AUTHOR`, `TRANSLATOR`, `PRESS`, `VERSION`, `OUTLINE`, `WANTREAD`, `READING`, `READ`, `DIRECTORY`, `PRICE`, `COVER_PIC`, `CLASSFY`) VALUES
	(1, '32141B', NULL, 'vvvvvvvvaaaaaaaaaaa#$@$@', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `t_bookdd` (
  ...
  `CLASSFY` varchar(45) DEFAULT NULL COMMENT '分类',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='当当网书籍详细信息';

# Dumping data for table bimokudb.t_bookdd: ~1 rows (approximately)
...
INSERT INTO `t_bookdd` (`ID`, `ISBN`, `UUID`, `BOOKNAME`, `AUTHOR`, `TRANSLATOR`, `PRESS`, `VERSION`, `OUTLINE`, `WANTREAD`, `READING`, `READ`, `DIRECTORY`, `PRICE`, `COVER_PIC`, `CLASSFY`) VALUES
	(1, '42141B', NULL, 'cavdvas2222@@@@@@@@我是擦拭', '31k擦擦撒j', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL);
