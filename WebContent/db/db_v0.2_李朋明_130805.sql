...
INSERT INTO `t_book` (`ID`, `ISBN`, `UUID`, `BOOKNAME`, `AUTHOR`, `TRANSLATOR`, `PRESS`, `VERSION`, `OUTLINE`, `WANTREAD`, `READING`, `HASREAD`, `DIRECTORY`, `PRICE`, `COVER_PIC`, `CLASSFY`, `RELATIONSHIP`) VALUES
	(1, '42141B', NULL, 'ddddddd', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL, '{"DD":"42141B","DB":"","AM":"42141B"}'),
	(2, '32141B', NULL, 'ddddddd', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL, '{"DD":"32141B","DB":"","AM":"32141B"}');
...
CREATE TABLE IF NOT EXISTS `t_bookamazon` (
  ...
  `CLASSFY` varchar(45) DEFAULT NULL COMMENT '分类',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='在亚马逊网站上面的书籍详细信息';
...
INSERT INTO `t_bookamazon` (`ID`, `ISBN`, `UUID`, `BOOKNAME`, `AUTHOR`, `TRANSLATOR`, `PRESS`, `VERSION`, `OUTLINE`, `WANTREAD`, `READING`, `READ`, `DIRECTORY`, `PRICE`, `COVER_PIC`, `CLASSFY`) VALUES
	(1, '32141B', '3124u091', 'ddddddd', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL),
	(2, '42141B', '3124u091', 'ddddddd', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `t_bookdd` (
  ...
  `CLASSFY` varchar(45) DEFAULT NULL COMMENT '分类',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='当当网书籍详细信息';
...
INSERT INTO `t_bookdd` (`ID`, `ISBN`, `UUID`, `BOOKNAME`, `AUTHOR`, `TRANSLATOR`, `PRESS`, `VERSION`, `OUTLINE`, `WANTREAD`, `READING`, `READ`, `DIRECTORY`, `PRICE`, `COVER_PIC`, `CLASSFY`) VALUES
	(1, '42141B', '3124u091', 'ddddddd', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL),
	(2, '32141B', '3124u091', 'ddddddd', '31kj', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22, NULL, NULL);
